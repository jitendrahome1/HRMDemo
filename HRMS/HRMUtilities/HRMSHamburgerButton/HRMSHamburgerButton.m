...
@implementation HRMSHamburgerButton
...
- (void)commonInit
{
    ...
    else
    {
        self.lineHeight = 2.0;
        self.lineWidth = 18;
        self.lineSpacing = 2.5;
    }
    
    self.animationDuration = .3;
    
    self->_currentMode = HRMSHamburgerButtonModeHamburger;
    [self updateAppearance];
}

- (void)setCurrentMode:(HRMSHamburgerButtonMode)currentMode
{
...
- (void)setCurrentModeWithAnimation:(HRMSHamburgerButtonMode)currentMode duration:(CGFloat)duration
{
    ...
    switch (self.currentMode) {
        case HRMSHamburgerButtonModeHamburger:
            switch (currentMode) {
                case HRMSHamburgerButtonModeHamburger:
                    // Nothing
                    break;
                case HRMSHamburgerButtonModeArrow:
                    [self transformFromHamburgerToArrow:duration];
                    break;
                case HRMSHamburgerButtonModeCross:
